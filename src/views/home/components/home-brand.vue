  ...
  <HomePanel title="热门品牌" sub-title="国际经典 品质保证">
    ...
    <div ref="target" class="box" >
      <Transition-group name="fade">
        <ul v-if="brands.length" :style="{transform:`translateX(${-index*1240}px)`}" class="list" >
...
export default {
  ...
  setup() {
    ...
    // useLazyData传入的时API函数，findBrand(10)传入的是Promise，当有参数时需自定义函数
    // 不对？？？：const { target, result } = useLazyData(() => findBrand(10))
